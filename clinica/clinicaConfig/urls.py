"""
URL configuration for clinicaConfig project.
...
schema_view = get_schema_view(
    openapi.Info(
        title="API Clínica de Estética",
        default_version='versão 1',
        description="Documentação da versão 1 da api de cliníca de estética",
    ),
    public=True,
